...
<head>
  ...
  <script src="//cdn.jsdelivr.net/hola_player/latest/hola_player.js?customer=XXXXX"></script>
  ...
</head>
```
...
<html>
  ...
  <script id=hola_jwplayer_hls_provider register-percent=50 src="//cdn.jsdelivr.net/hola_hap/1.0.33/hola_jwplayer_hls.min.js"></script>
  ...
</html>
```
...
<html>
  ...
  <script id=hola_flowplayer_hls_provider register-percent=50 src="//cdn.jsdelivr.net/hola_hap/1.0.33/hola_flowplayer_hls.min.js"></script>
  ...
</html>
```
...
<html>
  ...
  <script id=hola_videojs_hls_provider register-percent=50 src="//cdn.jsdelivr.net/hola_hap/1.0.33/hola_videojs_hls.min.js"></script>
  ...
</html>
```
...
[47]: https://cdn.jsdelivr.net/hola_hap/1.0.33/hola_jwplayer_hls.min.js "Right click > Save link as > JWPlayer HLS provider"
[48]: https://cdn.jsdelivr.net/hola_hap/1.0.33/hola_flowplayer_hls.min.js "Right click > Save link as > Flowplayer HLS Engine"
[49]: https://cdn.jsdelivr.net/hola_hap/1.0.33/hola_videojs_hls.min.js "Right click > Save link as > VideoJS HLS provider"
