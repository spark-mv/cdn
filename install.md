...
<head>
  ...
  <script src="//player2.h-cdn.com/hola_player.js?customer=XXXXX"></script>
  ...
</head>
```
...
| V7.11.0xx | `//player.h-cdn.com/jwplayer.flash.7_11_0.swf` |
| V7.12.8xx | `//player.h-cdn.com/jwplayer.flash.7_12_8.swf` |
...
[58]: https://rawgit.com/hola/shaka-player/v2.3.3-hola/release/shaka-player.compiled.js "Right click > Save link as > Shaka player v2.3.3"
